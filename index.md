...
address: "1280 Main Street West"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "43.256531"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-79.874420"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "November 22, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "3pm-5pm EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["John Fink", "Eris Discordia"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Pfeebe Dog", "Franklin Cat"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["john.fink@example.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
